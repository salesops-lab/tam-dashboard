// USPS state name <-> abbreviation table used only by the Product / Account
// Coverage section to normalize the second dataset. Isolated from the
// existing TAM dashboard's aggregation/filter logic.
